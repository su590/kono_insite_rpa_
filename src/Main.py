...
if __name__ == '__main__':
    ...
    scheduler.add_job(worker(getKonoTm2Feishu), args=(False,), trigger='cron', hour='*', minute=1)
    scheduler.add_job(worker(getKonoTm2Feishu), args=(True,), trigger='cron', hour='23', minute=55)
    scheduler.add_job(worker(getYesterdayKonoTm2Feishu), trigger='cron', hour='8', minute=0)
    scheduler.add_job(worker(getYesterdaySameHourKonoTm2Feishu), trigger='cron', hour='*', minute=1)
    scheduler.add_job(worker(getYesterdaySameHourKonoTm2Feishu), trigger='cron', hour='23', minute=55)
    scheduler.start()
