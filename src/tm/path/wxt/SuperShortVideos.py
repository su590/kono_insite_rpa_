...
def getSuperShortVideos(
    ...
    with open(os.path.join(dirname, 'params', 'SuperShortVideos.json'), 'r', encoding='utf-8') as f:
        params: dict[str, str] = json.load(f)
    with open(os.path.join(dirname, 'headers', 'SuperShortVideos.json'), 'r', encoding='utf-8') as f:
        headers: dict[str, str] = json.load(f)
    with open(os.path.join(dirname, 'payload', 'SuperShortVideos.json'), 'r', encoding='utf-8') as f:
