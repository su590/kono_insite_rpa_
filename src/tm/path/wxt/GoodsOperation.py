...
def getGoodsOperation(
	...
	with open(os.path.join(dirname, 'params', 'GoodsOperation.json'), 'r', encoding='utf-8') as f:
		params: dict[str, str] = json.load(f)
	with open(os.path.join(dirname, 'headers', 'GoodsOperation.json'), 'r', encoding='utf-8') as f:
		headers: dict[str, str] = json.load(f)
	with open(os.path.join(dirname, 'payload', 'GoodsOperation.json'), 'r', encoding='utf-8') as f:
